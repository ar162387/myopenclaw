...
export async function finalizeOnboardingWizard(
  ...
  await prompter.note(
    sensorTowerEnabled && sensorTowerToolAllowed
      ? hasSensorTowerToken
        ? [
            "Sensor Tower tool is configured.",
            "",
        ...
        : [
            "Sensor Tower tool is enabled, but no auth token is configured yet.",
            "",
            "Set it interactively:",
            `- Run: ${formatCliCommand("openclaw configure --section sensortower")}`,
            "",
            "Or set one env var in the Gateway environment:",
      ...
      : [
          "If you want Sensor Tower automation, configure it now or later.",
          "",
          `- Run: ${formatCliCommand("openclaw configure --section sensortower")}`,
